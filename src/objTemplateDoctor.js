const arrayTemplateDoctors = [
  {
    ...
    specialties: ["Medico General", "Ginecologia", "Obstetricia"],
    about_me: 'lorem ipsum',
    tuition_code: "CMP 15265",
    consultation_cost: 25.5,
    phone: ["956 256 222"],
    diseases_treated: ["ETS", "Verrugas", "Gonorrea"],
    location: {
      id: 1,
      city: "Bogota",
      country: "Colombia",
    ...
    reviews: [
      {
        id: 1,
        author: "Petra Perez",
        comment: "Excelente profesional me gusato mucho su consulta",
